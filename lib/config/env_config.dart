...
class EnvConfig {
  ...
  static const String appName = String.fromEnvironment(
    'APP_NAME',
    defaultValue: 'QuikApp Build System',
  );
  ...
  static const String webUrl = String.fromEnvironment(
    'WEB_URL',
    defaultValue: 'https://quikapp.co/',
  );
  static const String emailId = String.fromEnvironment(
    'EMAIL_ID',
    defaultValue: 'prasannasrinivasan32@gmail.com',
  );

  // Package Identifiers
  static const String pkgName = String.fromEnvironment(
    'PKG_NAME',
    defaultValue: 'com.quikapp.buildsystem',
  );
  ...
  static const bool isLoadInd = bool.fromEnvironment(
    'IS_LOAD_IND',
    defaultValue: true,
  );
  ...
  static const String splashDuration = String.fromEnvironment(
    'SPLASH_DURATION',
    defaultValue: '4',
  );
  ...
  static const String bottommenuItems = String.fromEnvironment(
    'BOTTOMMENU_ITEMS',
    defaultValue:
        '[{"label":"Home","icon":{"type":"preset","name":"home_outlined"},"url":"https://quikapp.co/"},{"label":"Features","icon":{"type":"preset","name":"featured_play_list"},"url":"https://quikapp.co/features"},{"label":"Documentation","icon":{"type":"preset","name":"description"},"url":"https://quikapp.co/docs"},{"label":"Support","icon":{"type":"preset","name":"support_agent"},"url":"https://quikapp.co/support"}]',
  );
  ...
  static const String bottommenuFontSize = String.fromEnvironment(
  ...
  static const String firebaseConfigAndroid = String.fromEnvironment(
    ...
    defaultValue:
        'https://raw.githubusercontent.com/prasanna91/QuikApp/main/google-services-TK.json',
  );
  ...
  static const String appleTeamId = String.fromEnvironment(
    'APPLE_TEAM_ID',
    defaultValue: '9H2AD7NQ49',
  );
  static const String apnsKeyId = String.fromEnvironment(
    'APNS_KEY_ID',
    defaultValue: 'V566SWNF69',
  );
  ...
  static const String profileType = String.fromEnvironment(
    'PROFILE_TYPE',
  ...
  static const String certPassword = String.fromEnvironment(
    'CERT_PASSWORD',
    defaultValue: 'qwerty123',
  );
  static const String certP12Url = String.fromEnvironment(
    'CERT_P12_URL',
    defaultValue:
        'https://raw.githubusercontent.com/prasanna91/QuikApp/main/Certificates.p12',
  );
  static const String certCerUrl = String.fromEnvironment(
    'CERT_CER_URL',
    defaultValue:
        'https://raw.githubusercontent.com/prasanna91/QuikApp/main/ios_distribution.cer',
  );
  static const String certKeyUrl = String.fromEnvironment(
    'CERT_KEY_URL',
    defaultValue:
  ...
  static const String appStoreConnectKeyIdentifier = String.fromEnvironment(
    'APP_STORE_CONNECT_KEY_IDENTIFIER',
    defaultValue: 'S95LCWAH99',
  );
  static const String appStoreConnectApiKey = String.fromEnvironment(
    'APP_STORE_CONNECT_API_KEY',
    defaultValue:
        'https://raw.githubusercontent.com/prasanna91/QuikApp/main/AuthKey_S95LCWAH99.p8',
  );
  static const String appStoreConnectApiKeyPath = String.fromEnvironment(
    'APP_STORE_CONNECT_API_KEY_PATH',
    defaultValue:
        'https://raw.githubusercontent.com/prasanna91/QuikApp/main/AuthKey_S95LCWAH99.p8',
  );
  static const String appStoreConnectIssuerId = String.fromEnvironment(
    'APP_STORE_CONNECT_ISSUER_ID',
    defaultValue: 'a99a2ebd-ed3e-4117-9f97-f195823774a7',
  );

  // Android Keystore Configuration
  static const String keyStoreUrl = String.fromEnvironment(
    'KEY_STORE_URL',
    defaultValue:
        'https://raw.githubusercontent.com/prasanna91/QuikApp/main/keystore.jks',
  );
  static const String cmKeystorePassword = String.fromEnvironment(
    'CM_KEYSTORE_PASSWORD',
    defaultValue: 'opeN@1234',
  );
  static const String cmKeyAlias = String.fromEnvironment(
    'CM_KEY_ALIAS',
    defaultValue: 'my_key_alias',
  );
  static const String cmKeyPassword = String.fromEnvironment(
    'CM_KEY_PASSWORD',
    defaultValue: 'opeN@1234',
  );

  // Email Notification System
  static const bool enableEmailNotifications = bool.fromEnvironment(
    'ENABLE_EMAIL_NOTIFICATIONS',
    defaultValue: true,
  );
  static const String emailSmtpServer = String.fromEnvironment(
    'EMAIL_SMTP_SERVER',
    defaultValue: 'smtp.gmail.com',
  );
  static const String emailSmtpPort = String.fromEnvironment(
    'EMAIL_SMTP_PORT',
    defaultValue: '587',
  );
  static const String emailSmtpUser = String.fromEnvironment(
    'EMAIL_SMTP_USER',
    defaultValue: 'prasannasrie@gmail.com',
  );
  static const String emailSmtpPass = String.fromEnvironment(
    'EMAIL_SMTP_PASS',
    defaultValue: 'lrnu krfm aarp urux',
  );

  // iOS Distribution Options
  static const bool enableDeviceSpecificBuilds = bool.fromEnvironment(
    'ENABLE_DEVICE_SPECIFIC_BUILDS',
    defaultValue: false,
  );
  static const String installUrl = String.fromEnvironment(
    'INSTALL_URL',
    defaultValue: '',
  );
  static const String displayImageUrl = String.fromEnvironment(
    'DISPLAY_IMAGE_URL',
    defaultValue: '',
  );
  static const String fullSizeImageUrl = String.fromEnvironment(
    'FULL_SIZE_IMAGE_URL',
    defaultValue: '',
  );
  static const String thinning = String.fromEnvironment(
    'THINNING',
    defaultValue: 'none',
  );

  // iOS Development Options
  static const bool enableDebugBuild = bool.fromEnvironment(
    'ENABLE_DEBUG_BUILD',
    defaultValue: false,
  );
  static const bool enableDeviceLogging = bool.fromEnvironment(
    'ENABLE_DEVICE_LOGGING',
    defaultValue: false,
  );
  static const bool enableDebugSymbols = bool.fromEnvironment(
    'ENABLE_DEBUG_SYMBOLS',
    defaultValue: false,
  );

  // Build Environment Variables
  static const String cmBuildId = String.fromEnvironment(
    'CM_BUILD_ID',
    defaultValue: '',
  );
  static const String cmBuildDir = String.fromEnvironment(
    'CM_BUILD_DIR',
    defaultValue: '',
  );
  static const String outputDir = String.fromEnvironment(
    'OUTPUT_DIR',
    defaultValue: 'output/ios',
  );

  // Helper methods
  static bool get isFirebaseEnabled => pushNotify;
  static bool get isAndroidWorkflow => workflowId.startsWith('android');
  static bool get isIosWorkflow =>
      workflowId.startsWith('ios') || workflowId == 'combined';
